<template>
  <Title>DevFest Modena 2024 &mdash; Workshop Marco Arena</Title>
  <div>
    <NuxtLayout name="speaker-page" speaker-image="marco-arena">
      <template #image>
        <img src="@/assets/svg/square-brackets.svg">
      </template>
      <template #title> Workshop Marco Arena</template>
      ...
      <template #talk>
        ...
        <p class="mb-3">
          ...
          public. We eliminate stress, anxiety, and strict deadlines, replacing them with a fun and friendly atmosphere
          that fosters creativity and personal growth.
        </p>
        <br/>
        <p>
      ...
      <template #description>
        ...
        <p>
          He is currently pioneering Artificial Intelligence adoption at Tetra Pak as a technical leader. Previously, he
          worked as a software engineer for the Ferrari F1 racing team, focusing on mission-critical software and
          driving the adoption of the latest C++ standards.
        </p>
        <p>
          Beyond coding, Marco is a seasoned community manager, blogger, and speaker with over 11 years of experience.
          He founded the Italian C++ Community (2013), Coding Gym (2016), and ML Modena (2020), and co-founded the ISO
          C++ Italian body (2020). His initiatives have attracted thousands of participants.
        </p>
        <p>
          Recognized for his contributions, Marco has received the Microsoft MVP award nine times since 2016,
          highlighting his significant impact on the community.
        </p>
        <br/>
        <!--Links-->
        <div class="flexbox" style="gap: 12px;">
          <a href="https://www.linkedin.com/in/marcoarena/" target="_blank">
