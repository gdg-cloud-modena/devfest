<template>
  <Title>DevFest Modena 2024 &mdash; News Crawler via Langchain.RB and Gemini APIs</Title>
  <div>
    <NuxtLayout name="speaker-page" speaker-image="riccardo-carlesso">
      <template #image>
        <img src="@/assets/svg/square-brackets.svg">
      </template>
      <template #title> News Crawler via Langchain.RB and Gemini APIs</template>
      ...
      <template #talk>
        ...
        <p>
          ...
          How about crawling the web for latest news with Gemini for multimodal extraction and offering summarization by
          your favorite topic?
      ...
      <template #description>
        <h2>Bio</h2>
        <p>
          Riccardo loves caipirinhas and Amarone, playing piano and triathlons; he's been passionate about Mathematics
          since he was 4.
          He's still in love with Ruby and Rails.
          Former network administrator, sysadmin, and Ruby on Rails developer, Riccardo has been in operations for 20+
          years and still likes to spend time coding (better if Ruby). He loves engaging with customers and help them
          run their operations reliably and successfully in the cloud.
        </p>
        <br/>
        <!--Links-->
