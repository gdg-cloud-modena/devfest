<template>
    ...
    <div class="flexbox column">
        <section 
            data-toggle
            class="flexbox column justify-center align-center full pad-24 mb-10"
        >   
            <div 
            ...
            >
                <div class="content text-center">
                    ...
                    <h2 class="text-secondary mt-4" style="text-align: center;">
                        Modena<br> 12 ottobre 2024
                    </h2>
                    <div class="mt-4">
                        <a class="inline-block" href="#info"><img src="@/assets/svg/chevron-down.svg" /></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        >   
            ...
            <div class="flex flex-col lg:flex-row">
                <div class="w-full lg:w-4/6 lg:pr-10">
                    <h3 class="mb-4" style="font-weight: normal;">DevFest è un evento dedicato agli sviluppatori, ospitato dai Google Developer Groups di tutto il mondo.</h3>
                    <h4 class="mb-6">
                        L'evento nasce dal lavoro congiunto delle communities locali: GDG Cloud Modena, Modena Full Stack, Flutter Modena, ML Modena, Conoscere Linux, Reggio Emilia Full Stack e GDG Bologna.
                    </h4>
                  <div class="pt-5">
                    <a class="button-like text-2xl py-5 px-7" href="https://www.eventbrite.it/e/devfest-modena-2024-tickets-1006887817567?aff=oddtdtcreator" target="_blank">Riserva un biglietto!</a>
                  </div>
                </div>
                <div class="w-full lg:w-2/6 flex flex-wrap mt-10 lg:mt-0">
        ...
        >
            <div class="flexbox justify-between column justify-center">
                ...
                <div class="flexbox column align-center" style="gap: 48px; flex: 1 1 200px;">
