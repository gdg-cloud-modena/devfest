    ...
    <NuxtLayout name="page">
      ...
      <template #content>
        <section class="px-10 pb-12 pt-10">
          <div class="text-xl">
            Durante questo evento, avrai l'opportunità di ascoltare e incontrare esperti del settore, innovatori e
            professionisti.
            Qui trovi tutte le informazioni sugli interventi in programma, con dettagli sugli argomenti trattati e i
            profili degli speaker che li presenteranno.
          </div>
          <div class="text-xl mt-4">
            Esplora il programma, scopri le storie e le competenze di chi salirà sul palco e preparati a vivere
