+++
title = "From dev to Platform Engineer with Pulumi IaC"
date = 2026-06-13
draft = false
...
Let's see how Pulumi and its supported programing languages bridge the gap between dev or devOps to Platform Engineering without language switching, while discussing how recent Terraform changes make now maybe the perfect time to adopt a truly code-first, open-source approach.
