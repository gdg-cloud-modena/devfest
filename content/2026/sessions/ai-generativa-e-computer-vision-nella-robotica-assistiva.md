+++
title = "AI Generativa e Computer Vision nella Robotica Assistiva"
date = 2026-06-13
draft = false
...
Successivamente, ci concentreremo su un robot collaborativo il cui compito è il passaggio di oggetti in modo fluido e contestuale al tipo di uso che l'utente deve farne. Vedremo un framework adattivo basato su AI per handover di oggetti robot-uomo, con obbiettivo di impiego in contesti casalinghi.
